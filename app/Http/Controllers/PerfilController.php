...
class PerfilController extends Controller
{
    ...
    public function getPerfil(Request $request){
        ...
        'documento'=>$documento,'contrato_firma'=>$contrato_firma,'contrato_pendiente'=>$contrato_pendiente,'historial_contrato'=>$historial_contrato,'contrato_total'=>$contrato_total,'contrato_vigente'=>$contrato_vigente]);
    }
