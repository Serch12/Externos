                          ...
                          <div class="repeater-wrapper pt-0 pt-md-9" data-repeater-item>
                            <div class="d-flex border rounded position-relative pe-0">
                              ...
                              <div
                                ...
                                <div class="dropdown">
                                  <i
                                    class="ri-settings-3-line cursor-pointer more-options-dropdown"
                                    role="button"
                        ...
                        <div class="row">
                          <div class="col-12">
                            <button type="button" class="btn btn-primary btn-sm" data-repeater-create>
                              <i class="ri-add-line ri-14px me-1_5"></i> Add Item
                            </button>
                          </div>
                        </div>
                      </form>
                ...
                <div class="col-lg-3 col-12 invoice-actions">
                  <div class="card mb-6">
                    <div class="card-body">
                      ...
                      <div class="d-flex">
                        <a href="./app-invoice-preview.html" class="btn btn-outline-secondary w-100 me-4 mb-4"
                          >Preview</a
                        >
